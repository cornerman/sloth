...
@implicitNotFound(msg = "Cannot find implicit MonadClientFailure[$Result]. Make sure there is an implicit cats.MonadError[$Result, ErrorType] and a sloth.ClientFailureConvert[ErrorType] for some ErrorType.")
