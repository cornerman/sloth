...
class ServerFactory[Encoder[_], Decoder[_], PickleType] {
  def apply[Result[_]](implicit
...
object Server {
  ...
  def apply[Encoder[_], Decoder[_], PickleType] = new ServerFactory[Encoder, Decoder, PickleType]
}
